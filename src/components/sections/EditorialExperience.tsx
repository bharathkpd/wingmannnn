...
export function EditorialExperience({ onOpenWaitlist }: EditorialExperienceProps) {
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto rounded-3xl md:rounded-[2.5rem] bg-[#141113] text-[#FFFDFB] p-6 sm:p-10 md:p-14 shadow-[0_25px_60px_-15px_rgba(25,21,23,0.35)] relative overflow-hidden border border-white/10">
        ...
        <div className="space-y-8 sm:space-y-10 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
            ...
            <div className="lg:col-span-6 space-y-3">
              <div className="relative aspect-[4/3] sm:aspect-[16/11] w-full max-w-[460px] mx-auto rounded-2xl sm:rounded-3xl overflow-hidden border border-white/15 shadow-xl bg-[#0E0C0D]">
              ...
              <div className="flex items-center justify-center gap-2 max-w-[460px] mx-auto overflow-x-auto no-scrollbar py-0.5">
                {steps.map((st, i) => (
                  <button
                    key={st.num}
