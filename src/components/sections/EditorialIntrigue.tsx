  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto rounded-3xl md:rounded-[2.5rem] bg-[#141113] text-[#FFFDFB] p-6 sm:p-12 md:p-16 shadow-[0_25px_60px_-15px_rgba(25,21,23,0.35)] relative overflow-hidden border border-white/10">
        ...
        <div
          className="pointer-events-none absolute -top-24 right-1/4 w-[320px] md:w-[550px] h-[320px] md:h-[550px] bg-[#8E2432]/20 rounded-full blur-[140px]"
          aria-hidden="true"
        />
        ...
        <div className="space-y-12 sm:space-y-16 relative z-10">
          ...
          >
            ...
            <h2 className="font-serif text-[clamp(1.75rem,5.5vw,4.5rem)] font-light leading-[1.08] tracking-tight text-[#FFFDFB] [text-wrap:balance]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <motion.div
              ...
              className="md:col-span-5 relative aspect-[16/10] sm:aspect-[4/3] rounded-2xl overflow-hidden border border-white/15 shadow-xl"
            >
              <Image
